llm_settings = {
    "gpt-4o":            {"show_name":"gpt-4o (OpenAI)", "vision":True, "provider":"openai", "tools":True, "stream":True},
    "gpt-4o-mini":       {"show_name":"gpt-4o-mini (OpenAI)","vision":True, "provider":"openai", "tools":True, "stream":True},
    "gpt-4-turbo":       {"show_name":"gpt-4-turbo (OpenAI)","vision":False, "provider":"openai", "tools":True, "stream":True},
    ...
    "llava-llama3":      {"show_name":"Llava-Llama3 (Ollama)","vision":True, "provider":"ollama", "tools":False, "stream":False},
    "llava-phi3":        {"show_name":"LLaVA-Phi-3 (Ollama)","vision":True, "provider":"ollama", "tools":False, "stream":False},
    "gemini-pro":        {"show_name":"gemini-pro (Google)","vision":True, "provider":"google", "tools":True, "stream":True},
    "mixtral-8x7b-groq": {"show_name":"Mixtral 8x7b (Groq)","vision":False, "provider":"groq", "tools":True, "stream":True},
}
...
https://github.com/DigitalFate/gpt-computer-assistant
