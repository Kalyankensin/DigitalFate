...
def settings_popup(self):
    ...
    online_tools_button = QPushButton("Enable DigitalFate Tiger Tools - More Capability (Recommended)")

    settings_dialog.layout().addWidget(online_tools_button)

    if is_online_tools_setting_active():
        online_tools_button.setText("Disable DigitalFate Tiger Tools - Low Capability (Not Recommended)")

        def deactivate_online_tools_():
            deactivate_online_tools_setting()
            the_main_window.update_from_thread("Disabled DigitalFate Tiger Tools - Low Capability (Not Recommended)")
            settings_dialog.close()
        ...
        online_tools_button.clicked.connect(deactivate_online_tools_)
            ...
            def activate_online_tools_():
                ...
                the_main_window.update_from_thread("Enabled DigitalFate Tiger Tools - More Capability (Recommended)")
                settings_dialog.close()
